...
\section{Research Interest}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Non-perturbative effects in field theory, Stokes phenomena.}
  \resumeSubHeadingListEnd
...
\section{Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Soft corrections to cosmological particle production}{Madison, WI}
      {In collaboration with Daniel Chung and Nidhi Sudhir}{Dec 2024 -- Present}
      \resumeItemListStart
        \resumeItem{My collaborators and I have been extending the topological contribution to Bogoliubov coefficients for long-wavelength modes (2408.11452) from k=0 to small but finite k. We found that global symmetries like time-reversal symmetry and single-valuedness of analytically-continued quantum modes severely constrain the coefficients.}
      \resumeItemListEnd
...
\section{Teaching Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItem{TA for Physics 322: Electromagnetic Fields (Spring. 2026)}
  \resumeSubHeadingListEnd
